...
![Alt text](Flow/CICD_Ans_Jen_K8.png)
  ```bash
#### #### #### ####  CICD_Jen_Ans_k8_Pipeline
#### This repo has a data entry application hosted on a Tomcat Server . Follow the below guidelines to create a CI/CD job out of it with tools such as EKS,Ansible,Jenkins,Docker.
